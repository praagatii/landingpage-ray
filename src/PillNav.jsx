...
const PillNav = ({
  ...
  useEffect(() => {
    ...
    const onResize = () => updateCircleGeo();
    window.addEventListener('resize', onResize);

    if (document.fonts?.ready) {
      document.fonts.ready.then(updateCircleGeo).catch(() => {});
    }
  ...
  return (
    <div className="pill-nav-container">
      <nav className={`pill-nav ${className}`} aria-label="Primary" style={cssVars}>
        {logo && (
          <a className="pill-logo" href="/" aria-label="Home" onMouseEnter={handleLogoEnter} ref={logoRef}>
